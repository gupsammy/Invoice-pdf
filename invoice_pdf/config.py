...
class Settings(BaseSettings):
    ...
    # Retry Configuration
    max_retries: int = Field(default=3, description="Maximum retry attempts per operation")
    retry_delay_base_seconds: int = Field(default=10, description="Base delay for exponential backoff")
