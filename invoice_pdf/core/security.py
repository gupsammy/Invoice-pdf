...
def validate_safe_path(file_path: Union[str, Path], allowed_extensions: tuple[str, ...] = ('.pdf',)) -> Path:
...
def create_secure_temp_path(base_dir: Union[str, Path], prefix: str = "invoice_pdf_") -> Path:
